...
print('max_features {}'.format( tree.max_features))
print('n_class {}'.format(tree.n_classes_))
print('n_feature {}'.format(tree.n_features_))
print('n_output {}'.format(tree.n_outputs_))
